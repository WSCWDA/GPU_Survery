...
\textbf{Problem statement.} NVMe-oF/RDMA enables storage pooling, but disaggregated deployments introduce tail latency, congestion coupling, and isolation challenges not captured by local-direct path models; emerging coherent-fabric directions further complicate control and placement assumptions \cite{nvmeof_spec,infiniband_spec,liu2017rackscale,cxl_spec}.
